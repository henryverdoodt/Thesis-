...
year_start = 1986
year_end = 2015
Climate_Models = ["CNRM", "EARTH", "HadGEM"]
...
for Climate_Model in Climate_Models
    ...
    for year in year_start:year_end 
        ...
        for node in N
            ...
            gen_dict[node]["Biomass"][year] = value.(m.ext[:parameters][:cap_exist][node])
        end
    end
    ...
    for reg in 1:2
        for unit in units
            ...
            output_file = "/Users/henryverdoodt/Documents/CODE/DATA/BOXPLOT_RES/$(unit)_$(region_name[reg])_$(Climate_Model)_$(year_start)_$(year_end)_fixed_network.csv"
