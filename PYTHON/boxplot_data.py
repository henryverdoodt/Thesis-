...
# WINDOFF SOUTH EU
windoff_ENTSO_25_1986_2015_year_South_EU = np.loadtxt('/Users/henryverdoodt/Documents/CODE/DATA/BOXPLOT/windoff_ENTSO_25_1986_2015_year_South_EU.csv', delimiter=',', skiprows=1); 
windoff_ENTSO_25_1986_2015_winter_South_EU = np.loadtxt('/Users/henryverdoodt/Documents/CODE/DATA/BOXPLOT/windoff_ENTSO_25_1986_2015_winter_South_EU.csv', delimiter=',', skiprows=1); 
...
windoff_ENTSO_25_1986_2015_year_South_EU_3H = np.mean(windoff_ENTSO_25_1986_2015_year_South_EU.reshape(-1, 3), axis=1); 
windoff_ENTSO_25_1986_2015_winter_South_EU_3H = np.mean(windoff_ENTSO_25_1986_2015_winter_South_EU.reshape(-1, 3), axis=1); 
...
windoff_CNRM_1979_2005_year_South_EU = np.loadtxt('/Users/henryverdoodt/Documents/CODE/DATA/BOXPLOT/windoff_CNRM_1979_2005_year_South_EU.csv', delimiter=',', skiprows=1); 
windoff_CNRM_1979_2005_winter_South_EU = np.loadtxt('/Users/henryverdoodt/Documents/CODE/DATA/BOXPLOT/windoff_CNRM_1979_2005_winter_South_EU.csv', delimiter=',', skiprows=1); 
...
windoff_CNRM_2071_2100_year_South_EU = np.loadtxt('/Users/henryverdoodt/Documents/CODE/DATA/BOXPLOT/windoff_CNRM_2071_2100_year_South_EU.csv', delimiter=',', skiprows=1); 
windoff_CNRM_2071_2100_winter_South_EU = np.loadtxt('/Users/henryverdoodt/Documents/CODE/DATA/BOXPLOT/windoff_CNRM_2071_2100_winter_South_EU.csv', delimiter=',', skiprows=1); 
...
windoff_EARTH_2071_2100_year_South_EU = np.loadtxt('/Users/henryverdoodt/Documents/CODE/DATA/BOXPLOT/windoff_EARTH_2071_2100_year_South_EU.csv', delimiter=',', skiprows=1); 
windoff_EARTH_2071_2100_winter_South_EU = np.loadtxt('/Users/henryverdoodt/Documents/CODE/DATA/BOXPLOT/windoff_EARTH_2071_2100_winter_South_EU.csv', delimiter=',', skiprows=1); 
...
windoff_HadGEM_2071_2100_year_South_EU = np.loadtxt('/Users/henryverdoodt/Documents/CODE/DATA/BOXPLOT/windoff_HadGEM_2071_2100_year_South_EU.csv', delimiter=',', skiprows=1); 
windoff_HadGEM_2071_2100_winter_South_EU = np.loadtxt('/Users/henryverdoodt/Documents/CODE/DATA/BOXPLOT/windoff_HadGEM_2071_2100_winter_South_EU.csv', delimiter=',', skiprows=1); 
...
bp_year = ax.boxplot([windoff_CNRM_1979_2005_year_South_EU, windoff_CNRM_2071_2100_year_South_EU, windoff_EARTH_2071_2100_year_South_EU, windoff_HadGEM_2071_2100_year_South_EU], positions=[1, 2, 3, 4], widths=0.6, patch_artist=True, showfliers=False, flierprops=flier_properties); 
bp_winter = ax.boxplot([windoff_CNRM_1979_2005_winter_South_EU, windoff_CNRM_2071_2100_winter_South_EU, windoff_EARTH_2071_2100_winter_South_EU, windoff_HadGEM_2071_2100_winter_South_EU], positions=[5, 6, 7, 8], widths=0.6, patch_artist=True, showfliers=False, flierprops=flier_properties); 
